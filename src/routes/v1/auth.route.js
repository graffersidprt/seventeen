...
// router.get('/comet',authController.comet);
// router.get('/sendComeChatUser',authController.sendComeChatUser);
router.get('/me',auth(),authController.me);
router.post('/register', validate(authValidation.register), authController.register);
router.post('/parent-register', validate(authValidation.register), authController.parentRegister);
//router.post('/agoraToken', authController.agoraToken);
...
router.post('/parent-login', validate(authValidation.login), authController.parentLogin);
